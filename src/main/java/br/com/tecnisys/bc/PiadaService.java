...
public class PiadaService {
    ...
    private void popularPiadas() {
        piadas.add(new Piada(1,"ALTERADO Qual tempero é odiado pelos outros? O sal grosso!"));
        piadas.add(new Piada(2,"ALTERADO Qual é o nome da cidade que molha os bêbados quando chove? BarSemLona"));
    }
}
